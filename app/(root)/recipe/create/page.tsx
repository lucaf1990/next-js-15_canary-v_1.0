...
export const formSchema = z.object({
  ...
  cookingTime: z.number().min(1, "Cooking time must be at least 1 minute").max(300, "Cooking time cannot exceed 300 minutes"),
  servings: z.number().min(1, "Must serve at least 1 person").max(100, "Servings cannot exceed 100"),
  image: z.string().url("Must be a valid URL").refine(async (url) => {
    try {
...
const RecipeForm = () => {
  ...
  async function handleFormSubmit(prevState: FormState, formData: FormData) {
    try {
      ...
      const result = await createRecipe(prevState, formData);
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                <div className="form-group">
                  ...
                  <Select name="category" required>
                    ...
                    <SelectContent>
                      {["Breakfast", "Lunch", "Dinner", "Dessert", "Snack", "Appetizer"].map((cat) => (
                ...
                <div className="form-group">
                  ...
                  />
                  {errors.cookingTime && (
                    <p className="text-sm text-red-500 mt-1">{errors.cookingTime}</p>
                  )}
                </div>
